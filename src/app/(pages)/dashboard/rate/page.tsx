...
const Rate: React.FC = () => {
  ...
  return (
    <div className="w-full flex flex-col min-h-screen bg-white pt-12 p-5">
        ...
        <div className="bg-gray-200 p-6 mb-10 rounded-lg justify-center items-center shadow-md w-full max-w-md">
          {submitted ? (
            ...
            <div className="w-full h-screen flex flex-col items-center justify-center bg-white p-4">
              ...
              <p className="text-xl">
                Houve uma falha no envio da avaliação. Tente mais tarde por
                favor.
              </p>
            </div>
          ) : (
            <>
              ...
              <p className="font-paragrafos text-sm mb-8">
                ...
                Isso nos ajuda a melhorar o nosso jeito de cuidar de você e do
                seu pequeno astronauta.
              </p>
              <form onSubmit={handleSubmit}>
                <div className="flex flex-col items-center">
                  <div className="text-6xl mb-4">
                    {getEmoji(hover || rating)}
                  </div>
